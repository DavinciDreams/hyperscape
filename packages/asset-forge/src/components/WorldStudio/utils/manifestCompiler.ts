/**
 * manifestCompiler — Pure compilation functions for world manifest generation
 *
 ...
 *
 * All functions in this file are pure: they take data and return JSON objects.
 * The React hook (useManifestCompiler) wraps these in useCallback for memoisation.
 */
 ...
 */
export function compileWorldJson(
  world: WorldData,
 ...
 */
export function compileWorldConfig(world: WorldData): Record<string, unknown> {
 ...
 */
export function compileWorldAreas(
  world: WorldData,
  extendedLayers: ExtendedWorldLayers,
 ...
 */
export function compileBiomes(world: WorldData): unknown[] {
 ...
 */
export function compileDangerSources(
  extendedLayers: ExtendedWorldLayers,
): Record<string, unknown> {
  return {
 ...
 */
export function compileBrushOverlays(
 ...
 */
export function compileWildernessBoundary(
  extendedLayers: ExtendedWorldLayers,
): Record<string, unknown> | null {
 ...
 */
export function compileBuildings(world: WorldData): Record<string, unknown> {
 ...
 */
export function compileRoads(world: WorldData): unknown[] {
...
/** Human-readable entity labels per manifest file */
 ...
 * This is the pure function that the hook's `compile` callback delegates to.
 */
export function compileAllManifests(
  world: WorldData,
  extendedLayers: ExtendedWorldLayers,
  audioLayers: AudioLayers,
  ...
  const worldJson = compileWorldJson(world, extendedLayers, vegetationTrees);
