import { Download, RotateCcw, Sparkles, Eye } from "lucide-react";
import React, { useRef } from "react";

import { useSmartFittingStore } from "../store/useSmartFittingStore";
...
export const SmartFittingPage: React.FC = () => {
        ...
        <div className="overflow-hidden flex-1 relative bg-gradient-to-br from-bg-primary to-bg-secondary rounded-xl">
          {selectedAvatar || selectedArmor ? (
            ...
            <div className="flex items-center justify-center h-full">
              <EmptyState
                icon={Sparkles}
                title="Smart Armor Fitting"
                description="Select an avatar and armor piece to begin single-pass BVH fitting"
              />
            </div>
          )}
        </div>
      ...
      <div className="card overflow-hidden w-80 flex flex-col bg-gradient-to-br from-bg-primary to-bg-secondary">
        <div className="p-4 border-b border-border-primary bg-bg-primary bg-opacity-30">
          ...
          <p className="text-xs text-text-tertiary mt-1">
            Normal-constrained projection with Taubin smoothing
          </p>
        </div>
          ...
          <div className="p-4 space-y-5">
            ...
            <div className="mt-6 p-3 rounded-lg bg-bg-tertiary/30 border border-white/5">
              ...
              <ol className="text-[11px] text-text-tertiary space-y-1.5 list-decimal list-inside">
                <li>Raycast along armor rest normals to find body surface</li>
                <li>Push constrained to normal direction (no lateral drift)</li>
                <li>Taubin λ/μ smoothing prevents mesh shrinkage</li>
                <li>Closest-point push-out guarantees no penetration</li>
                <li>UV seam welding + degenerate triangle repair</li>
              </ol>
            </div>
          </div>
        </div>
...
export default SmartFittingPage;
