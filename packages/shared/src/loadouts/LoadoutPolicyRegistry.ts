...
export type LoadoutPolicyReloadListener = () => void;

export class LoadoutPolicyRegistry {
  private _policy: LoadoutsManifest | null = null;
  private _reloadListeners = new Set<LoadoutPolicyReloadListener>();
   ...
   */
  onReloaded(cb: LoadoutPolicyReloadListener): () => void {
  ...
  private _emitReloaded(): void {
    ...
    for (const cb of this._reloadListeners) {
      try {
        ...
        console.warn(
          "[loadoutPolicyRegistry] reload listener threw:",
