...
export type ParentalControlsReloadListener = () => void;
...
export class ParentalControlsRegistry {
  ...
  private _reloadListeners = new Set<ParentalControlsReloadListener>();
   ...
   */
  onReloaded(cb: ParentalControlsReloadListener): () => void {
  ...
  private _emitReloaded(): void {
    ...
    for (const cb of this._reloadListeners) {
      try {
        ...
        console.warn(
          "[parentalControlsRegistry] reload listener threw:",
