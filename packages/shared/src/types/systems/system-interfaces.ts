...
// DuelSystem + DuelOperationResult + DuelSessionInfo migrated to
// `@hyperforge/hyperscape-plugin/types/duel-system-interface` 2026-04-27
// (top-10 #8, slice 29). The duel-types data shapes (DuelRules,
// DuelState, etc.) stay in shared/types/game/duel-types — they're
// bidirectional event-bus contracts.
