...
export type OnboardingGoalsReloadListener = () => void;
...
export class OnboardingGoalsRegistry {
  ...
  private _reloadListeners = new Set<OnboardingGoalsReloadListener>();
   ...
   */
  onReloaded(cb: OnboardingGoalsReloadListener): () => void {
  ...
  private _emitReloaded(): void {
    ...
    for (const cb of this._reloadListeners) {
      try {
        ...
        console.warn(
          "[onboardingGoalsRegistry] reload listener threw:",
