...
// Editor mode no longer registers grass by default — load the
// plugin or register manually.
...
// BuildingRenderingSystem migrated to @hyperforge/hyperscape
// (2026-04-25). Editor mode no longer registers it by default —
// load the plugin or register manually.
...
export function createEditorWorld(options: EditorWorldOptions): EditorWorld {
  ...
  // "grass" migrated to @hyperforge/hyperscape (2026-04-25). Editor
  // mode no longer registers it by default.
