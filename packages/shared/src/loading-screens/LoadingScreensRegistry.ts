...
export type LoadingScreensReloadListener = () => void;
...
export class LoadingScreensRegistry {
  ...
  private _reloadListeners = new Set<LoadingScreensReloadListener>();
   ...
   */
  onReloaded(cb: LoadingScreensReloadListener): () => void {
  ...
  private _emitReloaded(): void {
    ...
    for (const cb of this._reloadListeners) {
      try {
        ...
        console.warn(
          "[loadingScreensRegistry] reload listener threw:",
