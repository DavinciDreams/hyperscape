...
/**
 * `IBroadcastManager` was relocated to
 * `./substrate/broadcast-service.ts` and renamed `IBroadcastService`
 * (PLAN_ENGINE_API_EXTRACTION.md Phase A2, 2026-04-26). This alias
...
export type { IBroadcastService } from "./substrate/broadcast-service";
export type IBroadcastManager = IBroadcastService;
