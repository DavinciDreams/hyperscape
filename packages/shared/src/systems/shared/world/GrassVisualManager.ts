  ...
  private dispatchLodSwap(
    ...
    const input: GrassWorkerInput = {
      ...
      shaderConstants: {
        ...
        DIRT_NOISE_LO_OFFSET: TERRAIN_SHADER_CONSTANTS.DIRT_NOISE_LO_OFFSET,
        DIRT_NOISE_HI_OFFSET: TERRAIN_SHADER_CONSTANTS.DIRT_NOISE_HI_OFFSET,
        DIRT_FLAT_HI: TERRAIN_SHADER_CONSTANTS.DIRT_FLAT_HI,
        DIRT_FLAT_LO: TERRAIN_SHADER_CONSTANTS.DIRT_FLAT_LO,
        DIRT_BELL_LO: TERRAIN_SHADER_CONSTANTS.DIRT_BELL_LO,
        DIRT_BELL_MID: TERRAIN_SHADER_CONSTANTS.DIRT_BELL_MID,
        DIRT_BELL_FALL: TERRAIN_SHADER_CONSTANTS.DIRT_BELL_FALL,
        DIRT_BELL_END: TERRAIN_SHADER_CONSTANTS.DIRT_BELL_END,
        DIRT_BELL_STR: TERRAIN_SHADER_CONSTANTS.DIRT_BELL_STR,
        CLIFF_LO: TERRAIN_SHADER_CONSTANTS.CLIFF_LO,
        CLIFF_HI: TERRAIN_SHADER_CONSTANTS.CLIFF_HI,
        SAND_H_HI: TERRAIN_SHADER_CONSTANTS.SAND_H_HI,
        SAND_H_LO: TERRAIN_SHADER_CONSTANTS.SAND_H_LO,
        SAND_SLOPE: TERRAIN_SHADER_CONSTANTS.SAND_SLOPE,
        SAND_STR_MIN: TERRAIN_SHADER_CONSTANTS.SAND_STR_MIN,
        SAND_STR_MAX: TERRAIN_SHADER_CONSTANTS.SAND_STR_MAX,
        SHORE1_HI: TERRAIN_SHADER_CONSTANTS.SHORE1_HI,
        SHORE1_LO: TERRAIN_SHADER_CONSTANTS.SHORE1_LO,
        SHORE1_STR: TERRAIN_SHADER_CONSTANTS.SHORE1_STR,
        SHORE2_HI: TERRAIN_SHADER_CONSTANTS.SHORE2_HI,
        SHORE2_LO: TERRAIN_SHADER_CONSTANTS.SHORE2_LO,
        SHORE2_STR: TERRAIN_SHADER_CONSTANTS.SHORE2_STR,
        SHORE3_HI: TERRAIN_SHADER_CONSTANTS.SHORE3_HI,
        SHORE3_LO: TERRAIN_SHADER_CONSTANTS.SHORE3_LO,
        SHORE3_STR: TERRAIN_SHADER_CONSTANTS.SHORE3_STR,
      },
      roadSegments,
      roadBlendWidth: 0.5,
