...
/**
 * Priority-based fish rolling system
 *
 ...
 * Automatically uses priority rolling when drops have catchLow/catchHigh.
 *
 * @param drops - Array of possible drops from manifest harvestYield
 * @param playerLevel - Optional player skill level (required for priority rolling)
 * @param debug - Enable debug logging
...
export function rollDrop(
  ...
  // TICK-ACCURACY: Check if drops use priority rolling (catchLow/catchHigh defined)
