 ...
 *
 * Relocated to
 * `packages/shared/src/systems/server/network/PendingAttackManager.ts` as
...
export { PendingAttackManager } from "../../../../shared/src/systems/server/network/PendingAttackManager";
