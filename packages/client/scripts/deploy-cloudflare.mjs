 ...
 *
 * Production domains: https://hyperscape.club, https://hyperia.gg
 */
...
async function main() {
  ...
  console.log('   Domains: https://hyperscape.club, https://hyperia.gg')
  ...
  try {
    ...
    if (PRODUCTION) {
      console.log('\n📡 Production URLs: https://hyperscape.club, https://hyperia.gg')
    } else {
