        ...
        style={{
          ...
          background:
            theme.name === "hyperscape"
              ? "linear-gradient(180deg, rgba(255, 249, 239, 0.052) 0%, transparent 14%, transparent 78%, rgba(0, 0, 0, 0.075) 100%), radial-gradient(circle at top right, rgba(183, 140, 76, 0.06), transparent 32%)"
