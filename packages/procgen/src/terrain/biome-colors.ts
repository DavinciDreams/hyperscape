 ...
 *
 * Used by both TerrainShader.ts (game client, via @hyperforge/shared re-export)
 * and TerrainShaderTSL.ts (procgen / Asset Forge).
 *
 * Moved from @hyperforge/shared/world/biome-colors to break the shared↔procgen
 * circular dependency (procgen/terrain/TerrainShaderTSL.ts imported this from
 * shared). shared now re-exports it from procgen.
 */
