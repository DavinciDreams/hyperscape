 ...
 * - TerrainShader.ts (game renderer, via @hyperforge/shared re-export)
 ...
 *
 * Moved from @hyperforge/shared/utils/noise/PerlinNoise to break the
 * shared↔procgen circular dependency (procgen/terrain/TerrainShaderTSL.ts
 * was importing this from shared). shared now re-exports it from procgen.
 */
